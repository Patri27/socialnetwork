...
async function sendEmailRegistration(userEmail, verificationCode) {
  const msg = {
    ...
    html: `To confirm the account <a href="${process.env.HTTP_SERVER_DOMAIN}/api/account/activate-account?verification_code=${verificationCode}">activate it here</a>`,
  };
...
async function create(req, res, next) {
  ...
  try {
    ...
    res.status(204).json();
    /**
     * We are going to create minimum structure in mongodb
     */
